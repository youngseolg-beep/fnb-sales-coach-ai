...
const CoachV4Page: React.FC<Props> = ({
  ...
  const rows = [
    { key: "analysis" as const, icon: "fa-chart-column", title: "기간 분석", copy: "선택한 기간의 변화와 상위 메뉴를 비교합니다.", badge: `매출 ${salesChangeRate >= 0 ? "+" : ""}${salesChangeRate.toFixed(1)}%`, color: "text-[#735ce8]" },
