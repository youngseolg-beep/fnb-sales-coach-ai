...
const SummaryPage: React.FC<Props> = ({
  ...
  return (
    <div className="mx-auto w-full max-w-[390px] pb-[108px] pt-[3px] text-[#1f1f1f] lg:max-w-[1180px] lg:pb-8">
      ...
      <section data-tour="home-today-summary" className="mt-[14px] rounded-[20px] border border-[#e5ded9] bg-white px-[18px] py-[16px] shadow-[0_3px_12px_rgba(63,42,30,0.045)]">
      ...
      <section data-tour="home-tasks" className="mt-[15px] rounded-[17px] border border-[#e5ded9] bg-white px-[18px] py-[14px] shadow-[0_3px_12px_rgba(63,42,30,0.045)]">
